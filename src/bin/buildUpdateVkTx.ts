...
if (!possibleAdminGroupPubKey58) issues.push('Missing required third argument: <admin-group-pub-key>');
...
await notifier.notify({
    ...
    command: `npm run verify-update-vk-tx -- ${fromTag} ${toTag} ${adminGroupPubKey.toBase58()}`,
});
